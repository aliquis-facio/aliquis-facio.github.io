# [Community Plugins] Clear Unused Images

**노트에서 더 이상 링크되지 않는 이미지 파일을 찾아 삭제하거나 휴지통으로 보내는 정리 플러그인**이다. 
...
1. **Community plugins** 화면에서 **Browse** 클릭
	![|500x265](./_image/2026-04-14-15-02-44.png)
2. 검색창에 `Clear Unused Images` 입력
	![|500x266](./_image/2026-04-14-15-03-07.png)
3. 검색 결과에서 해당 플러그인 선택

### 3. 설치

1. 플러그인 상세 화면에서 **Install** 클릭
	![|500x266](./_image/2026-04-14-15-03-13.png)
2. 설치가 끝날 때까지 기다림

### 4. Enable 활성화

1. 설치가 끝나면 **Enable** 클릭
	![|500x266](./_image/2026-04-14-15-03-19.png)
...
![|500x266](./_image/2026-04-14-15-03-33.png)

## 3. 설정

![|500x266](./_image/2026-04-14-15-04-21.png)
...
[1]: https://github.com/ozntel/oz-clear-unused-images-obsidian/blob/master/README.md "oz-clear-unused-images-obsidian/README.md at master · ozntel/oz-clear-unused-images-obsidian · GitHub"