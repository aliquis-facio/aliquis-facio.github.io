...
1. [에지(Edge)](#-에지edge)
	1. [에지 검출 기초](#1-에지-검출-기초)
		1. [연속/이산 미분](#11-연속이산-미분)
		2. [에지 모델과 1차/2차 미분](#12-에지-모델과-1차2차-미분)
		3. [잡음과 스무딩: 가우시안/가우시안 미분](#13-잡음과-스무딩-가우시안가우시안-미분)
		4. [에지 모델과 연산자](#14-에지-모델과-연산자)
		5. [에지 강도와 에지 방향](#15-에지-강도와-에지-방향)
	2. [영(0)교차 이론](#2-영0교차-이론)
		1. [가우시안](#21-가우시안)
			1. [가우시안 사용 이유](#211-가우시안-사용-이유)
			2. [가우시안 수식](#212-가우시안-수식)
		2. [LOG 필터](#22-log-필터)
	3. [컬러 에지](#3-컬러-에지)
		1. [채널별 처리의 한계](#31-채널별-처리의-한계)
		2. [디 젠조(Di Zenzo) 접근](#32-디-젠조di-zenzo-접근)
