...
1. [설치 방법](#2-설치-방법)
      ...
      1. [설치](#22-설치)
      1. [Enable 활성화](#23-enable-활성화)
      1. [설정 화면 진입](#24-설정-화면-진입)
1. [설정](#3-설정)
      1. [`Deleted Image Destination`](#31-deleted-image-destination)
      1. [`Excluded Folder Full Paths`](#32-excluded-folder-full-paths)
      1. [`Exclude Subfolders`](#33-exclude-subfolders)
      1. [`Delete Logs`](#34-delete-logs)
      1. [`Ribbon Icon`](#35-ribbon-icon)
1. [사용 예시](#4-사용-예시)
      1. [스크린샷 정리용](#41-스크린샷-정리용)
      1. [특정 폴더는 보호하고 싶을 때](#42-특정-폴더는-보호하고-싶을-때)
      1. [리본 아이콘으로 빠르게 실행](#43-리본-아이콘으로-빠르게-실행)
1. [추천 활용법](#5-추천-활용법)
      1. [첨부 폴더가 분리돼 있을 때 더 유용함](#51-첨부-폴더가-분리돼-있을-때-더-유용함)
      1. [대규모 삭제 전에 백업](#52-대규모-삭제-전에-백업)
      1. [주기적 정리 루틴 만들기](#53-주기적-정리-루틴-만들기)
1. [주의사항](#6-주의사항)
      1. [처음부터 `Permanently Delete`를 선택함](#61-처음부터-permanently-delete를-선택함)
      1. [공용 이미지 폴더를 제외하지 않음](#62-공용-이미지-폴더를-제외하지-않음)
      1. [“사용 중” 기준을 잘못 이해함](#63-사용-중-기준을-잘못-이해함)
      1. [실행 전에 로그 옵션을 안 켬](#64-실행-전에-로그-옵션을-안-켬)
1. [참고](#참고)
