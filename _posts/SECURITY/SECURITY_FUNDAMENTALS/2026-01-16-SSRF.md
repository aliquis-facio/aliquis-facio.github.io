...
1. [정의](#1-정의)
2. [동작 원리](#2-동작-원리)
3. [CSRF v.s. SSRF](#3-csrf-vs-ssrf)
4. [공격 시나리오](#4-공격-시나리오)
5. [보안대책](#5-보안대책)
    1. [“식별된 신뢰 시스템”만 호출하면 되는 경우](#51-식별된-신뢰-시스템만-호출하면-되는-경우)
        1. [애플리케이션 계층](#511-애플리케이션-계층)
        2. [네트워크 계층](#512-네트워크-계층)
    2. [“어떤 외부 IP/도메인”도 호출해야 하는 경우](#52-어떤-외부-ip도메인도-호출해야-하는-경우)
        1. [애플리케이션 계층에서 URL 차단이 어려운 이유](#521-애플리케이션-계층에서-url-차단이-어려운-이유)
        2. [애플리케이션 계층](#522-애플리케이션-계층)
        3. [네트워크 계층](#523-네트워크-계층)
    3. [클라우드 환경: IMDSv2(AWS)](#53-클라우드-환경-imdsv2aws)
6. [우회 기법](#6-우회-기법)
    1. [Short URL 기능을 이용](#61-short-url-기능을-이용)
    2. [Redirect 기능을 이용](#62-redirect-기능을-이용)
7. [출처](#출처)
...
![404x331](https://cdn.jsdelivr.net/gh/aliquis-facio/aliquis-facio.github.io@main/_image/2026-01-16-10-16-40.png)
...
![500x200](https://cdn.jsdelivr.net/gh/aliquis-facio/aliquis-facio.github.io@main/_image/2026-01-16-13-21-21.png)
*출처: [OWASP: Server-Side Request Forgery Prevention Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Server_Side_Request_Forgery_Prevention_Cheat_Sheet.html)*
...
![500x504](https://cdn.jsdelivr.net/gh/aliquis-facio/aliquis-facio.github.io@main/_image/2026-01-16-11-43-27.png)
...
![500x227](https://cdn.jsdelivr.net/gh/aliquis-facio/aliquis-facio.github.io@main/_image/2026-01-16-11-40-59.png)
...
[\[CTF\] Dreamhack 문제 풀이: web ssrf](../CTF/2026-01-30-web-ssrf.md)
[\[CTF\] Dreamhack 문제 풀이: username:password@](../CTF/2026-03-21-username-password.md)
