...
1. [웹(Web)이란?](#1-웹web이란)
1. [웹 서버(Web Server)란?](#2-웹-서버web-server란)
    1. [APM이란?](#21-apm이란)
    1. [웹서버 동작](#22-웹서버-동작)
        1. [URL VS URI](#221-urluniform-resource-locator-vs-uriuniform-resource-identifier)
        1. [URL과 www.naver.com과는 너무 다르다](#222-url과-wwwnavercom과는-너무-다르다)
        1. [Web Root](#223-web-root)
        1. [index.html](#224-indexhtml)
1. [참고](#참고)
...
##### 2.2.2. URL과 `www.naver.com`과는 너무 다르다
