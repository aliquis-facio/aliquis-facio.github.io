...
1. [HTTP란?](#1-http란)
2. [HTTP의 역할과 특징](#2-http의-역할과-특징)
3. [HTTP VS HTTPS](#3-http-vs-https)
4. [HTTP 요청](#4-http-요청)
    1. [HTTP METHOD](#41-http-method)
    2. [HTTP 요청 헤더](#42-http-요청-헤더)
    3. [HTTP 요청 본문](#43-http-요청-본문)
5. [HTTP 응답](#5-http-응답)
    1. [HTTP 응답 코드(상태 코드)](#51-http-응답-코드상태-코드)
    2. [HTTP 응답 헤더란?](#52-http-응답-헤더란)
    3. [HTTP 응답 본문](#53-http-응답-본문)
6. [HTTP/1.X와 HTTP/2](#6-http1x와-http2)
7. [멀티플렉싱(Multiplexing)](#7-멀티플렉싱multiplexing)
8. [서버 푸시(Server Push)](#8-서버-푸시server-push)
9. [헤더 압축(Header Compression)](#9-헤더-압축header-compression)
10. [http/1.1이랑 http/2랑 호환이 될까?](#10-http11이랑-http2랑-호환이-될까)
11. [참고](#참고)
...
![Alt Images](/_image/2024-11-14-00-00-00.png)
...
![Alt Images]("/_image/2024-11-14-00-00-01.png")
...
[HTTP란?](../../../_unstaged/DEVELOPMENT/WEB_SERVER/HTTP.md)
