...
* [1. LAN(Local Area Network)](#1-lanlocal-area-network)
* [1.1. 근거리 통신 개요](#11-근거리-통신-개요)
* [1.1.1. 개념](#111-개념)
* [1.1.2. 특징](#112-특징)
* [1.1.3. 장단점](#113-장단점)
* [1.1.3. 장점](#1131-장점)
* [1.1.3. 단점](#1132-단점)
* [1.3. 근거리 통신 프로토콜](#13-근거리-통신-프로토콜)
* [1.3.1. ALOHA(Adiitive Links Online Hawaii Area)](#131-alohaadiitive-links-online-hawaii-area)
* [1.3.2. Slotted ALOHA](#132-slotted-aloha)
* [1.3.3. CSMA/CD](#133-csmacd)
* [1.4. IEEE 802 위원회의 LAN 표준안](#14-ieee-802-위원회의-lan-표준안)
* [2. 이더넷(Ethernet)](#2-이더넷ethernet)
* [2.1. 개요](#21-개요)
* [2.2. 장단점](#22-장단점)
* [2.2.1. 장점](#221-장점)
* [2.2.2. 단점](#222-단점)
* [2.3. 표준](#23-표준)
* [2.4. UTP 케이블(Cable)](#24-utp-케이블cable)
* [2.5. UTP 케이블 배열](#25-utp-케이블-배열)
* [3. 고속 이더넷(Fast Ethernet)](#3-고속-이더넷fast-ethernet)
* [3.1. 개요](#31-개요)
* [3.2. 특징](#32-특징)
* [3.3. 기존 이더넷과의 차이점](#33-기존-이더넷과의-차이점)
* [4. 기가비트 이더넷(Gigabit Ethernet)](#4-기가비트-이더넷gigabit-ethernet)
* [4.1. 개요](#41-개요)
* [4.2. 특징](#42-특징)
* [5. 토큰 패싱(Token Passing)](#5-토큰-패싱token-passing)
* [5.1. 개요](#51-개요)
* [5.2. 특징](#52-특징)
* [5.3. 장단점](#53-장단점)
...
## 1.3. 근거리 통신 프로토콜(Protocol)

### 1.3.1. ALOHA(Adiitive Links Online Hawaii Area)
...
### 1.3.3. CSMA/CD([Carrier](#footnote_1)<sup>1</sup> Sense Multiple Access/Collision Detection)
...
## 1.4. IEEE(Institute of Electrical and Electronics Engineers) 802 위원회의 LAN 표준안
...
## 2.4. UTP 케이블(Unshielded Twisted Pair Cable)
