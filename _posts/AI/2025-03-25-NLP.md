...
1. [NLP에 대한 접근 방식](#2-nlp에-대한-접근-방식)
    ...
    1. [딥 러닝 NLP](#23-딥러닝-nlp)
1. [NLP 작업](#3-nlp-작업)
    1. [동일 지시성 해결](#31-동일-지시성-해결)
    1. [명명된 엔티티 인식(NER)](#32-명명된-엔티티-인식ner-named-entity-recognition)
    1. [품사 태그 지정](#33-품사-태그-지정pos-tagging-part-of-speech-tagging)
    1. [단어 의미 명확화](#34-단어-의미-명확화word-sense-disambiguation)
