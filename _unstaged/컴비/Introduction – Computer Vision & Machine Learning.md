## 1. Introduction – Computer Vision & Machine Learning 요약
...
- 슬라이드 구조상 **AI ⊃ Machine Learning ⊃ Deep Learning** 의 포함 관계로 설명.
...
- **Tom Mitchell의 정의 (1998)**
    
    > 어떤 컴퓨터 프로그램이 작업 T를 수행하고, 성능을 측정하는 척도 P에 따라 평가할 때,  
    > 경험 E를 통해 T에 대한 성능이 개선된다면, 그 프로그램은 **E로부터 학습한다**고 말할 수 있다.
