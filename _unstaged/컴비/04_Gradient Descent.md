# <font color="#ff0000">Gradient Descent</font>
## 1. 챕터 개요
...
- **Convex + smooth** 함수이고 η가 충분히 작으면, 임의의 작은 거리 ε̃에 대해 **전역 최적점 주변까지 수렴**
- η가 너무
...
- **Non-convex 함수**:
    ...
    - gradient descent는 **초기값 $x_{init}$** 에 따라 **서로 다른 local minimum**으로 수렴.
