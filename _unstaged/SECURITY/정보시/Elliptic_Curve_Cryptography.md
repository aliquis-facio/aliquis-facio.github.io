...
![2025-09-03-20-26-32](/_image/2025-09-03-20-26-32.png)

타원 곡선은 다음 방정식으로 정의되는 수학적 곡선이다.
$$
y^2 = x^3 + ax + b
$$
여기서 a와 b는 상수이다. 암호화에서 우리는 유한체에 대한 타원 곡선을 사용하는데, 이는 x와 y 좌표가 특정 범위의 정수로 제한되는 것을 의미한다.
...
- 비특이적이다.
	- 첨점이 없다.
	- 자기교차점이 없다
- 곡선은 각 수직선과 최대 3개의 점에서 교차한다.

### 연산


![2025-09-03-20-26-49](/_image/2025-09-03-20-26-49.png)
